...
exports.push = function (path, zone, bucket, prefix, accessKey, secretKey , recursion) {
	//需要用户输入的命令行参数
		...
		return new Promise((resolve)=>{
			return formUploader.putFile(uploadToken, key, localFile, putExtra, function (respErr,
				...
				if (respInfo.statusCode == 200) {
					...
					console.log(chalk.red("ERROR:there may be some err with code :" + respInfo.statusCode ));
					console.log( "ERR Info : " + respBody);
				}
			});
		});
	};
